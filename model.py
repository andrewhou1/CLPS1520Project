...
class CNNModel:
    def __init__(self, hidden_size_1, hidden_size_2, patch_size, batch_size, num_classes, learning_rate):
        ...
        print "params:", batch_size, patch_size, hidden_size_1, hidden_size_2, num_classes
        ...
        W_conv3 = tf.Variable(tf.truncated_normal([1, 1, self.hidden_size_2, num_classes], stddev=0.1))
